                            ...
                            <tr class="block md:table-row bg-surface hover:bg-surface-container-low transition-colors mb-4 md:mb-0 rounded-2xl md:rounded-none border border-outline-variant/30 md:border-none shadow-sm md:shadow-none overflow-hidden">
                                <td class="block md:table-cell py-3 md:py-4 px-4 whitespace-nowrap border-b border-outline-variant/10 md:border-none">
                                    <div class="flex justify-between items-center md:block">
                                        ...
                                        <div class="font-bold text-on-surface text-right md:text-left"><?= htmlspecialchars($product->getName()) ?></div>
                                    </div>
                                </td>
                                <td class="block md:table-cell py-3 md:py-4 px-4 font-medium text-secondary-container whitespace-nowrap border-b border-outline-variant/10 md:border-none">
                                    <div class="flex justify-between items-center md:block">
                                        <span class="md:hidden font-bold text-xs uppercase text-on-surface-variant">Harga</span>
                                        <div class="text-right md:text-left">Rp. <?= number_format((float)$product->getPrice(), 0, ',', '.') ?></div>
                                    </div>
                                </td>
                                <td class="block md:table-cell py-3 md:py-4 px-4 text-on-surface-variant text-sm whitespace-nowrap border-b border-outline-variant/10 md:border-none">
                                    <div class="flex justify-between items-center md:block">
                                        <span class="md:hidden font-bold text-xs uppercase text-on-surface-variant">Koordinat (Peta)</span>
